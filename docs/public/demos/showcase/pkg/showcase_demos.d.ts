...
export function run_image_demo(): void;

export function run_input_demo(): void;

export function run_shader_demo(): void;

export type InitInput = RequestInfo | URL | Response | BufferSource | WebAssembly.Module;

export interface InitOutput {
    readonly memory: WebAssembly.Memory;
    readonly run_image_demo: () => void;
    readonly run_input_demo: () => void;
    readonly run_shader_demo: () => void;
    readonly spottedcat_push_platform_event: (a: number, b: number) => void;
    ...
    readonly wasm_bindgen__convert__closures_____invoke__hfeb346a66046b6b5: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h6f1a24c91db74eeb: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__hd383ead9c8c12040: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h46506d146430e233: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h46506d146430e233_4: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h46506d146430e233_5: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h46506d146430e233_6: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h46506d146430e233_7: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h46506d146430e233_8: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h46506d146430e233_9: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h46506d146430e233_10: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h8f994b65aabb5911: (a: number, b: number) => void;
